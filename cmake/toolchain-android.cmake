...
if(NOT DEFINED ANDROID_TOOLCHAIN_DIR AND DEFINED ENV{ANDROID_TOOLCHAIN_DIR})
    set(ANDROID_TOOLCHAIN_DIR $ENV{ANDROID_TOOLCHAIN_DIR})
endif()
...
if(NOT DEFINED ANDROID_SDK_DIR AND DEFINED ENV{ANDROID_SDK_DIR})
    set(ANDROID_SDK_DIR $ENV{ANDROID_SDK_DIR})
endif()
...
if(NOT DEFINED ANDROID_NDK_DIR AND DEFINED ENV{ANDROID_NDK_DIR})
    set(ANDROID_NDK_DIR $ENV{ANDROID_NDK_DIR})
endif()
